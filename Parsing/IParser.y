{
-- | This module is automatically generated from the file @IParser.y@ by Happy,
-- the Haskell parser generator. It provides a function to parse
-- Proto-Quipper interface files.
...
{
-- | Take a list of tokens, and return the parsed interface. This is the main parsing function for interface files.
