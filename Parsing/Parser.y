{
-- | Module auto-generated by Happy, that provides a parsing function to parse module implementations.
...
-- | Main function. Takes a list of tokens, and returns the parsed program.
parse :: [Token] -> Program
