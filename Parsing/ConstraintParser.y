{
-- | Module auto-generated by Happy, that provides a function to parse constraint sets.
-- This function is used exclusively to parse the argument of the --unify option, that serves
-- to test the unification on a specific constraint set.
