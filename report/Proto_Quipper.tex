...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    is defined with $\dom(\binding)=\FQ(a_2)$. Moreover, $\FQ(a_2)\subseteq\mathtt{Out}(C)$ by the validity of the typed closure {\eqref{eqn-fqa2}}. Therefore, by Definition~\hyperref[Append_cond_2]
    {\ref*{circuit_constructor}.\ref*{Append_cond_2}}, $\dom(\binding')=Out(D)
