...
SOURCE_MODULES = Builtins.hs Classes.hs Console.hs Interactive.hs	\
  ...
  Compiler/Preliminaries.hs Compiler/SimplSyntax.hs Compiler/Circ.hs Compiler/CPS.hs Compiler/Interfaces.hs Compiler/CPStoLLVM.hs Compiler/Alternate.hs Compiler/AlttoLLVM.hs
