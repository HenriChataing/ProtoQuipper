...
GHC_OPTS:=-fwarn-incomplete-patterns -fwarn-incomplete-uni-patterns -Werror -prof -fprof-auto
...
SOURCE_MODULES = Builtins.hs Classes.hs Console.hs Interactive.hs	\
  ...
  Compiler/Preliminaries.hs Compiler/SimplSyntax.hs Compiler/QLib.hs Compiler/CPS.hs
