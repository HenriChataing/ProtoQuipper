...
\begin{defn}{\bf Typing rules} A typing judgement is a sequent of the form $\Gamma \vdash_\mathcal{L} t : T$, holding the
  ...
  $!^I \Gamma = x_1 : \,!^{i_1}A_1 \dots x_n : \,!^{i_n}A_n$ and $I = \{i_1 \dots i_n\}$. \\
	...
	\begin{prooftree}
		\AxiomC{}
		\RightLabel{$(1)$}
			\UnaryInfC{$!^I \Gamma \vdash_{\{1 \le I\}} 1 : \,!^n\top$}
	\end{prooftree}
	\begin{prooftree}
		...
		By induction on the typing derivation of $t$ : if the last typing rule used is
			\begin{itemize}
			    ...
			    \begin{prooftree}
					...
					\end{prooftree}
					with $I = 1 \dots 1$. With the solved constraint set $\mathcal{L} = \{1 \le I\}$,
			...
			\begin{itemize}
				\item{$(1)$} The typing derivation is
					\begin{prooftree}
						\AxiomC{}
						\RightLabel{$(1)$}
						\UnaryInfC{$!^I \Delta \vdash_{\{ 1 \le I \}} 1 : \,!^n\top$}
					\end{prooftree}
					By hypothesis, $\sigma I = 1 \dots 1$.
		...
		\begin{itemize}
			\item $(1)$. The typing derivation is
				\begin{prooftree}
					...
					\UnaryInfC{$!^I\Gamma \vdash_{\{1 \le I\}} 1 : \,!^n\top$}
				\end{prooftree}
				The condition $T <: U$ ensures that $U$ is of the form $!^m\top$.
				By application of the rule $(1)$ of LL', the derivation
				\begin{prooftree}
					\AxiomC{}
					\RightLabel{$(1)$}
					\UnaryInfC{$!^{I'}\Delta \vdash_{\{ 1 \le I' \}} 1 : \,!^m\top$}
				\end{prooftree}
				is valid. By transitivity, the relation
				$\mathcal{L} \cup \{!^{I'} \Delta <: \,!^I \Gamma\} \cup \{!^n\top <: ~!^m\top\} \vdash \{ 1 \le I' \}$ holds.
		...
		\begin{itemize}
			\item $1$, the algorithm applied to $!^I \Gamma \vdash 1 : T$ produces the set
				...
				\begin{prooftree}
					\AxiomC{}
					\RightLabel{$(ax)$}
					\UnaryInfC{$\sigma !^I \Gamma \vdash_{\{1 \le \sigma I\}} 1 : \,!^m\top$}
				\end{prooftree}
				holds.
			...
			\item $t u$, the algorithm applied to $\Gamma \vdash t u : T$ makes two recursive calls
				...
				The induction hypothesis applied twice with $\sigma$ as the solution yields the typing derivations
					\begin{prooftree}
						\AxiomC{$\Pi_1$}
						\UnaryInfC{$\sigma\Gamma|_t \vdash_{\mathcal{L_\sigma}_1} t : \,!^{\sigma(n)} \sigma(\alpha) \multimap \sigma T$}
					\end{prooftree}
					\begin{prooftree}
						\AxiomC{$\Pi_2$}
				...
				$\sigma \Gamma \vdash_\mathcal{L_\sigma} t u : \sigma T$, with $\mathcal{L_\sigma} =
					...
					\begin{prooftree}
						\AxiomC{$\Pi_1$} \noLine
						\UnaryInfC{$\sigma\Gamma_1, \sigma!^I\Delta \vdash_{\mathcal{L_\sigma}_1 \cup \{ 1 \le \sigma I_1 \}}
							t : \,!^{\sigma(n)} \sigma(\alpha) \multimap \sigma T$}
						\AxiomC{$\Pi_2$} \noLine
						\UnaryInfC{$\sigma\Gamma_2, \sigma!^I\Delta \vdash_{\mathcal{L_\sigma}_2 \cup \{ 1 \le \sigma I_2 \}}
							t : \,!^{\sigma(n)} \sigma(\alpha)$}
						\RightLabel{$(app)$}
						\BinaryInfC{$\sigma\Gamma \vdash_\mathcal{L_\sigma} t u : \sigma T$}
					\end{prooftree}
					\end{center}
