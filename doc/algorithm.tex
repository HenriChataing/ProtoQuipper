...
\begin{defn} If $\sigma$ and $\tau$ are substitutions, we write $\sigma \circ \tau$ for the composition of $\sigma$ with $\tau$, defined as follow
...
We can now formalize the problem of the type inference. For a complete discussion about the significance of type variables
	...
	\begin{proof}
		...
		\item $t \, u$. Supposing that
		  ...
		  Consequently, $\sigma'$ is a solution for $((\Gamma_1, \Delta), ~t, ~!^0(!^n \multimap T))$ verifying $dom(\sigma') \cap \chi_1 = \varnothing$.
			...
			It also verifies $dom(\sigma^*) \cap \chi_2 = \varnothing$. By the induction hypothesis, there exists $\sigma^{**}$ solution of
