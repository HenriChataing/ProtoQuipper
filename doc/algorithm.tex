...
\begin{exmp} Let $f$ be $\lambda x.x$ of type $!^n \alpha$, $a$ of type $!^m \beta$ and $t = f \, a$. Then
	\begin{center}
	\begin{tabular}{l}
		$[!^n\alpha ~\mapsto~ !^1(!^0\intx \multimap !^1\intx),~~ !^m\beta ~\mapsto~ !^1\intx,~~ !^p\gamma ~\mapsto~ !^1\intx]$ \\
		$[!^n\alpha ~\mapsto~ !^0(!^0\qubit \multimap !^0\bit),~~ !^m\beta ~\mapsto~ !^0\qubit,~~ !^p\gamma ~\mapsto~ !^0\qubit]$ \\
