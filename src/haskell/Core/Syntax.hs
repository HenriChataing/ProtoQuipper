...
circ0 :: Type -> Type -> Type
circ0 t u = apply 0 "circ" [t, u]

-- | Build the type !0 T -> U.
arrow0 :: Type -> Type -> Type
arrow0 t u = apply 0 "->" [t, u]
...
-- | Build constraint information with source expression.
fromSource :: Type -> ConstraintSource -> ConstraintInfo
fromSource typ source = ConstraintInfo True (Just typ) source
...
-- | Return true iff the constraint /T/ <: /U/ is atomic, meaning /T/ and /U/ are both of the form
-- !^/n/ /a/, where /a/ is a type variable.
isAtomic :: TypeConstraint -> Bool
isAtomic (SubLinearType (TypeVar _) (TypeVar _) _) = True
isAtomic _ = False
